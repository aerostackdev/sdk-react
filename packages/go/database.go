...
func newDatabase(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Database {
	return &Database{
		rootSDK:          rootSDK,
...
func (s *Database) DbQuery(ctx context.Context, request operations.DbQueryRequestBody, opts ...operations.Option) (*operations.DbQueryResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/db/query")
	if err != nil {
	...
	res := &operations.DbQueryResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.DbQueryResult
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DbQueryResult = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
