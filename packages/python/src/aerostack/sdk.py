...
from aerostack import models, utils
from aerostack._hooks import SDKHooks
...
class SDK(BaseSDK):
    r"""Aerostack API: Aerostack Platform API - Unified access to database, authentication,
